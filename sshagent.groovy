...
String agentList = build.buildVariableResolver.resolve('TestAutoAgent')
...
agentList.eachLine {
    ...
    DumbSlave dumb = new DumbSlave(it,  // Agent name, usually matches the host computer's machine name
            ...
            Mode.any,             // "Usage" field, EXCLUSIVE is "only tied to node", NORMAL is "any"
            "JAVA NODEJS ANSIBLE",                         // Labels
            new JNLPLauncher(),         // Launch strategy, JNLP is the Java Web Start setting services use
            RetentionStrategy.Always) // Is the "Availability" field and INSTANCE means "Always"
