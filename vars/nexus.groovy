def nexus(COMPONENT) {
  ...
  command = "curl -f -v -u admin:admin123 --upload-file /home/ubuntu/workspace/TODO_CI-Pipelines/${FILENAME} http://172.31.52.12:8081/repository/${COMPONENT}-ci/${FILENAME}"
